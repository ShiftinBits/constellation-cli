...
describe('LanguageDetector', () => {
	...
	describe('detectLanguage', () => {
		it('should detect JavaScript files', () => {
			...
			expect(detector.detectLanguage('components/Button.jsx')).toBe(
				'javascript',
			);
		});
		...
		it('should handle file paths with directories', () => {
			expect(detector.detectLanguage('/path/to/project/src/main.ts')).toBe(
				'typescript',
			);
			expect(detector.detectLanguage('./relative/path/file.js')).toBe(
				'javascript',
			);
		});
		...
		it('should handle absolute paths', () => {
			expect(detector.detectLanguage('/home/user/project/main.py')).toBe(
				'python',
			);
		});

		it('should handle Windows-style paths', () => {
			expect(detector.detectLanguage('C:\\Users\\test\\app.js')).toBe(
				'javascript',
			);
		});
	});
